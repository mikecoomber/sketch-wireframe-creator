...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/create-wireframe.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/create-wireframe.js":
/*!*********************************!*\
  !*** ./src/create-wireframe.js ***!
  \*********************************/
...
function changeLayerColour(layer) {
  if (layer.type === 'ShapePath') {
    ...
    var _color = layer.style.textColor;
    layer.style.textColor = getNewColor(_color);
  }
}

function getNewColor(color) {
  var colorInt = parseInt(color.slice(1, color.length - 1), 16);
...
//# sourceMappingURL=__create-wireframe.js.map